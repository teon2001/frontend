...
const getUsersPageQueryKey = "getUsersPageQuery";
...
export const useUserApi = () => {
    ...
    const getUsersPage = (page: ApiUserGetPageGetRequest) => new UserApi(config).apiUserGetPageGet(page);
